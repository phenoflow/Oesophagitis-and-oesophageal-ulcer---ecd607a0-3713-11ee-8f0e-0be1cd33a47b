...
steps:
  ...
  oesophagitis-and-oesophageal-ulcer---secondary:
    run: oesophagitis-and-oesophageal-ulcer---secondary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  output-cases:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: oesophagitis-and-oesophageal-ulcer---secondary/output
class: Workflow
inputs:
  inputModule1:
    id: inputModule1
