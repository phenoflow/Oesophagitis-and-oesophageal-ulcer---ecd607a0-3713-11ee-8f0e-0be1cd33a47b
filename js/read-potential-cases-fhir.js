...
(async () => {
  ...
  await fs.writeFile("oesophagitis-and-oesophageal-ulcer-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("oesophagitis-and-oesophageal-ulcer-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
